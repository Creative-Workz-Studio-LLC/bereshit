...
// ============================================================================
//
// Key:     B-sdk-engine-tests
// Purpose: Unit tests for the MapperEngine
//

pub static PRAGMA: &[(&str, &str)] = &[
    ("I1.key", "B-sdk-engine-tests"),
    ("I1.format", "rust"),
    ("I1.from", "src/engine/tests/mod.rs"),
    ("I1.at", "a-01.00"),
    ("I2.type", "code"),
...
pub static METADATA: &[(&str, &str)] = &[
    ...
    ("C5.purpose", "Unit tests for the MapperEngine"),
    ("C5.philosophy", "[philosophy]"),
    ("C6.current", "a-01.00 — Unit tests for the MapperEngine"),
    ("C6.planned", "[planned]"),
...
// Tests moved to tests/ integration directory following fixture pattern

#[test]
fn test_identity_accessors() {
    // Note: Since these are in mod.rs, we test this file's own identity
    assert_eq!(pragma_get("I1.key"), Some("B-sdk-engine-tests"));
    assert_eq!(metadata_get("C2.organization"), Some("CreativeWorkzStudio LLC"));
    
    // Exercise the slice accessors as well
    assert!(pragma().len() > 0);
...
// X5: Note
// ──────────────────────────────────────────────────────────────────────────
// Note: Unit tests for the MapperEngine
