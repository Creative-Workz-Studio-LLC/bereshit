...
// ============================================================================
//
// Key:     B-sdk-engine-mod
// Purpose: Core JSON/TOML mapping logic
//

pub static PRAGMA: &[(&str, &str)] = &[
    ("I1.key", "B-sdk-engine-mod"),
    ("I1.format", "rust"),
    ("I1.from", "src/engine/mod.rs"),
    ("I1.at", "a-01.00"),
    ("I2.type", "code"),
...
pub static METADATA: &[(&str, &str)] = &[
    ...
    ("C5.purpose", "Core JSON/TOML mapping logic"),
    ("C5.philosophy", "[philosophy]"),
    ("C6.current", "a-01.00 — Core JSON/TOML mapping logic"),
    ("C6.planned", "[planned]"),
...
mod identity_tests {
    ...
    fn test_identity_accessors() {
        assert_eq!(pragma_get("I1.key"), Some("B-sdk-engine-mod"));
...
// X5: Note
// ──────────────────────────────────────────────────────────────────────────
// Note: Core JSON/TOML mapping logic
