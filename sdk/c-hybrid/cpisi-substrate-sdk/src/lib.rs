//omni:key B-sdk-cpisi-substrate-lib
//omni:code --rust -library
//omni:version a-01.00

//! CPI-SI Substrate SDK Core Library

// ============================================================================
// METADATA
// ============================================================================
//
// Key:     B-sdk-cpisi-substrate-lib
// Purpose: Universal substrate mapping engine core
//

pub static PRAGMA: &[(&str, &str)] = &[
    ("I1.key", "B-sdk-cpisi-substrate-lib"),
    ("I1.format", "rust"),
    ("I1.from", "src/lib.rs"),
    ("I1.at", "a-01.00"),
    ("I2.type", "code"),
    ...
    ("I2.role", "[role]"),
    ("I3.file", "lib.rs"),
    ("I3.title", "CPI-SI Substrate SDK Core Library"),
...
pub static METADATA: &[(&str, &str)] = &[
    ...
    ("C5.purpose", "Universal substrate mapping engine core"),
    ("C5.philosophy", "[philosophy]"),
    ("C6.current", "a-01.00 — Universal substrate mapping engine core"),
    ("C6.planned", "[planned]"),
...
mod tests {
    ...
    fn test_identity_accessors() {
        assert_eq!(pragma_get("I1.key"), Some("B-sdk-cpisi-substrate-lib"));
...
// X5: Note
// ──────────────────────────────────────────────────────────────────────────
// Note: Universal substrate mapping engine core
