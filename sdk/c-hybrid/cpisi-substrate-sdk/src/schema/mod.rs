//omni:key B-sdk-schema-mod
//omni:code --rust -module
//omni:version a-01.00

//! Substrate Schema Definitions

// ============================================================================
// METADATA
// ============================================================================
//
// Key:     B-sdk-schema-mod
// Purpose: TOML schema bindings for substrate maps
//

pub static PRAGMA: &[(&str, &str)] = &[
    ("I1.key", "B-sdk-schema-mod"),
    ("I1.format", "rust"),
    ("I1.from", "src/schema/mod.rs"),
    ("I1.at", "a-01.00"),
    ("I2.type", "code"),
    ...
    ("I2.role", "[role]"),
    ("I3.file", "mod.rs"),
    ("I3.title", "Substrate Schema Definitions"),
...
pub static METADATA: &[(&str, &str)] = &[
    ...
    ("C5.purpose", "TOML schema bindings for substrate maps"),
    ("C5.philosophy", "[philosophy]"),
    ("C6.current", "a-01.00 — TOML schema bindings for substrate maps"),
    ("C6.planned", "[planned]"),
...
mod identity_tests {
    ...
    fn test_identity_accessors() {
        assert_eq!(pragma_get("I1.key"), Some("B-sdk-schema-mod"));
...
// X5: Note
// ──────────────────────────────────────────────────────────────────────────
// Note: TOML schema bindings for substrate maps
