// ============================================================================
// METADATA - Code Skill Configuration
// ============================================================================
// Purpose: Load and provide access to code-config.toml
...
// Config represents the full code configuration
type Config struct {
...
// Block represents a 4-block code block
type Block struct {
	Name     string   `toml:"name"`
...
// Load reads the configuration from code-config.toml
func Load() (*Config, error) {
	searchPaths := pkgtoml.SkillConfigPaths("create-code")

	configPath, err := pkgtoml.FindConfig("code-config.toml", searchPaths)
	if err != nil {
		return nil, err
	}
...
func (c *Config) GetLanguageNames() []string {
...
// GetLanguage returns a specific language
func (c *Config) GetLanguage(name string) (Language, bool) {
...
// GetBlockNames returns all block names in order (4-block)
func (c *Config) GetBlockNames() []string {
	return []string{"metadata", "setup", "body", "closing"}
}
