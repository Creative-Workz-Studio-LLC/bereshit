...
_"But let your communication be, Yea, yea; Nay, nay."_ — Matthew 5:37 KJV

_"But let your 'Yes' be 'Yes' and your 'No' be 'No.'"_ — Matthew 5:37 WEB

'''

*<<overview,Overview>>* • *<<truth-values,Truth Values>>* • *<<monadic-ops,Monadic Operations>>* • *<<dyadic-ops,Dyadic Operations>>* • *<<comparison,Comparison>>* • *<<derived-constants,Constants>>*
...
This document defines the *logic algorithms* for balanced ternary systems. While link:ternary-arithmetic-algorithms.adoc[Ternary Arithmetic Algorithms] handles numerical computation, this document specifies *logical operations* — how truth values combine.

[IMPORTANT]
====
*Three-valued logic is not a compromise between true and false.* The middle value represents genuine *uncertainty* or *unknown* — a fundamentally different epistemic state. This maps directly to balanced ternary's natural center at zero.
====
...
| *1920*
| Jan Łukasiewicz
| First formal three-valued logic system (Ł3)
...
[TIP]
====
*Kleene logic (K3)* is the standard three-valued logic for computer science. It treats the middle value as "unknown but determinate" — something that IS either true or false, we just don't know which.
====
...
* *KJV:* "Yea, yea" (+1, +1) and "Nay, nay" (-1, -1) — clear affirmation and denial
* *WEB:* "'Yes' be 'Yes'" and "'No' be 'No'" — same truth, different encoding
* *Both:* "Whatsoever is more than these" / "Whatever is more" — the problematic middle
...
* `T AND U = U` — True AND something-unknown is still unknown
* `F AND U = F` — False AND anything is false (short-circuit)
* `U AND U = U` — Two unknowns remain unknown
====
...
* `F OR U = U` — False OR something-unknown is still unknown
* `T OR U = T` — True OR anything is true (short-circuit)
* `U OR U = U` — Two unknowns remain unknown
====
...
function IMPLIES(a, b):
    return OR(NOT(a), b)    // Standard definition: ¬a ∨ b
----
...
These constants extend `word/core/ternary-math.toml` with logic algorithm data.
...
| *True (+1)*
| "Yea, yea" / "'Yes' be 'Yes'" — Clear affirmation

| *False (-1)*
| "Nay, nay" / "'No' be 'No'" — Clear denial

| *Unknown (0)*
| "Whatsoever is more than these" / "Whatever is more" — The problematic middle ground that "cometh of evil" / "is of the evil one"
|===
...
* *James 5:12 KJV* — "Let your yea be yea; and your nay, nay; lest ye fall into condemnation."
* *James 5:12 WEB* — "Let your 'yes' be 'yes,' and your 'no,' 'no;' so that you don't fall into hypocrisy."
...
_"Let your yea be yea; and your nay, nay."_ — *James 5:12 KJV*
