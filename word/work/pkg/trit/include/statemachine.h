...
#include "trit.h"        // Base trit type
#include "dimension.h"   // Cognitive dimensions
#include "temporal.h"    // Temporal states (9 modes)
#include "hebrew.h"      // Hebrew states (7 positions)
#include "cube.h"        // 27-position cube
#include "kalign.h"      // K:ALIGN tracking
#include "trajectory.h"  // Framework trajectory
...
//
// Basic Include:
//   #include "statemachine.h"  // Includes everything
//
// Create State:
//   cognitive_state_t state = cognitive_state_create();
//
