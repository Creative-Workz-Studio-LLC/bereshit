...
//--- Project Headers ---
#include "trit/matter/trit.type.h"    // trit_t type definition
#include "trit/space/cube.nav.h"      // cube_position_t for spatial context
#include "trit/time/kalign.nav.h"     // k_align_t for directional context
...
//   echo '#include "trit/trajectory.h"' | gcc -x c -fsyntax-only -std=c99 -I. -
//
