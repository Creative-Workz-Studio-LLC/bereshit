...
//--- Generated Headers ---
#include "trit/generated/scripture_text.gen.h"  // TOML-derived constants
...
//   echo '#include "trit/scripture_text.h"' | gcc -x c -fsyntax-only -std=c99 -I. -
//
