...
#include "trit/space/dimension.nav.h"  // direction_t for navigation
#include "trit/time/hebrew.state.h"     // hebrew_state_t for Z-axis mapping
...
//   echo '#include "trit/cube.h"' | gcc -x c -fsyntax-only -std=c99 -I. -
//
