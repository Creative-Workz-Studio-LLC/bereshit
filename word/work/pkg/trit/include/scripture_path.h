...
//--- Project Headers ---
#include "bible_rail.h"     // variant_location_t, bible_rail_variant_location()
#include "verse_addr.h"     // verse_addr_t, verse_addr_is_variant()
#include "scripture_text.h" // scripture_text_encode/decode, completes the chain
...
//   echo '#include "scripture_path.h"' | gcc -x c -fsyntax-only -std=c99 -I. -
//
