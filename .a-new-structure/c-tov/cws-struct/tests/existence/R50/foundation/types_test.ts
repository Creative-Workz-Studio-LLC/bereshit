...
// ============================================================================
//
// file:    tests/T00/R50/foundation/types_test.ts
...
Deno.test("[CWS-T00-090] types/error: creates error-severity result", () => {
...
Deno.test("types/summarize: includes health when provided", () => {
  const health = {
    total: 85,
    level: "perfect" as const,
    emoji: "\u{2705}",
    direction: 1 as const,
    hardpoint: 100 as const,
    trite: 242, // all perfect: [+1,+1,+1,+1,+1]
    blocks: [],
    totalActions: 10,
    alignedCount: 8,
    neutralCount: 0,
