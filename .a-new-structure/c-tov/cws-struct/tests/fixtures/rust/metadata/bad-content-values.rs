...
//! # Bad Content Values Fixture
//!
//! Valid structure and all fields present, but field VALUES are wrong.
...
pub static PRAGMA: &[(&str, &str)] = &[
    ...
    ("I3.path",      "tests/fixtures/rust/metadata/bad-content-values.rs"),
...
pub static METADATA: &[(&str, &str)] = &[
    ...
    ("C4.consumers",         "tests/handlers/rust_test.ts"),
];
