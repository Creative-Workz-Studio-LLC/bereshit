...
// ============================================================================
//
// file:    lib/schema-loader.ts
// key:     B-tov-cws-struct-lib-schema-loader
...
export async function loadRules(): Promise<DerivedRules> {
  ...
  if (!meta || !content || !closing) {
    throw new Error(
      `Schema validation_contract missing metadata/content/closing sections`,
    );
  }
