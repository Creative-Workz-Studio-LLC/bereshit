...
// ---------------------------------------------------------------------------
// Lint Grid Focus — block × layer slicing
// ---------------------------------------------------------------------------
//
// The lint grid has two axes: Block (vertical) and Layer (horizontal).
// Focus options let you slice the grid for targeted execution.
//
//   --check metadata     → vertical slice (one block column)
//   --check R25          → horizontal slice (one layer row)
//   --check metadata:R25 → single cell
//   (no --check)         → full grid, block-first traversal
//
...
/** Lint grid focus options — which slice of the block × layer grid to execute. */
