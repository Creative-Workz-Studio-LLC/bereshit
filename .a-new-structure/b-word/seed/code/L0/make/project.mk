...
# provides:  MAKEFILE_PROJECT
#
# --- P5: Summary ---
# title:     Project Makefile Template
# brief:     4-block build template for general projects — CWS standards reference
#
# TEMPLATE: Project Makefile (4-Block Structure)
# STRUCTURE: METADATA → SETUP → BODY → CLOSING
# USAGE: cp project.mk Makefile → update pragma → fill sections
#
# ═══════════════════════════════════════════════════════════════════════════
# END PRAGMA [END]
# ═══════════════════════════════════════════════════════════════════════════
...
#   toml:         None
#   json:         None
#   editorconfig: template.editorconfig — co-located formatting template
