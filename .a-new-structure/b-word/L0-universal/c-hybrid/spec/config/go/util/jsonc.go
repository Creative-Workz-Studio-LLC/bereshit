...
func ParseJSONC(content []byte) ([]byte, error) {
	...
	// Remove single-line comments (string-aware)
...
// stripLineComment removes a single-line // comment from a line,
// respecting JSON string boundaries. Walks character by character
