...
export function createValidateView() {
    ...
    el.appendChild(createCommandCard({
        ...
        onRun: () => {
            ...
            if (type)
                args.push('--type', type);
            if (bonusToggle.isChecked())
                args.push('--bonus');
            if (reportToggle.isChecked())
                args.push('--report');
    ...
    el.appendChild(createCommandCard({
        ...
        onRun: () => {
            ...
            if (lintVerbose.isChecked())
                args.push('--verbose');
            if (lintReport.isChecked())
                args.push('--report');
    ...
    el.appendChild(createCommandCard({
        ...
        onRun: () => {
            ...
            if (witnessVerbose.isChecked())
                args.push('--verbose');
            if (witnessJson.isChecked())
                args.push('--json');
