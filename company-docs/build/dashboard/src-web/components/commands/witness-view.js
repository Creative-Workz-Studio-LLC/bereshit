...
// Main View
// =============================================================================
export function createWitnessView() {
...
// JSON Parsing
// =============================================================================
function parseWitnessJSON(stdout) {
...
// Dashboard Renderer
// =============================================================================
function renderDashboard(container, report) {
    // ── Health Banner ───────────────────────────────────────────
    ...
    const healthOrder = { fail: 0, warn: 1, skipped: 2, pass: 3 };
...
function renderHealthBanner(report) {
    ...
    const valueMap = { healthy: '+1', degraded: '0', failing: '-1' };
...
// Domain Cards
// =============================================================================
function renderDomainCard(summary) {
    const card = document.createElement('div');
