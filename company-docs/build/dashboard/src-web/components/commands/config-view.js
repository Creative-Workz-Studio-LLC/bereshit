 ...
 */
import { createConfigEditor } from '../config-screens/editor-base.js';
import { attributesEditor, formatsEditor, watchEditor, displayEditor, brandEditor, typographyEditor, pageLayoutEditor, legalEditor, toneEditor, docTypesEditor, companyEditor, variantsEditor, pageFillEditor, } from '../config-screens/index.js';
...
export function createConfigView() {
    ...
    function showEditor(sectionKey) {
