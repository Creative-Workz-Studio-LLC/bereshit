 ...
 */
export function createConfigEditor(def, onBack) {
 ...
 */
export function configInput(label, value, opts) {
 ...
 */
export function configNumber(label, value, opts) {
    const wrapper = document.createElement('div');
    wrapper.className = 'form-group';
    const lbl = document.createElement('label');
    lbl.className = 'form-label';
 ...
 */
export function configBool(label, value) {
    const wrapper = document.createElement('div');
    wrapper.className = 'form-group';
 ...
 */
export function configColor(label, value) {
    const wrapper = document.createElement('div');
    wrapper.className = 'form-group';
    wrapper.style.display = 'flex';
    wrapper.style.alignItems = 'center';
 ...
 */
export function configSelect(label, value, options) {
    const wrapper = document.createElement('div');
    wrapper.className = 'form-group';
    const lbl = document.createElement('label');
    lbl.className = 'form-label';
 ...
 */
export function configStringArray(label, values, opts) {
    const wrapper = document.createElement('div');
    wrapper.className = 'form-group';
    const lbl = document.createElement('label');
    lbl.className = 'form-label';
 ...
 */
export function configKeyValue(label, data) {
    const wrapper = document.createElement('div');
    wrapper.className = 'form-group';
    const lbl = document.createElement('label');
    lbl.className = 'form-label';
 ...
 */
export function configSection(title) {
    const el = document.createElement('div');
