...
export const companyEditor: EditorDefinition = {
  ...
  buildForm(data: unknown) {
    ...
    interface MemberRow {
      ...
      title: ReturnType<typeof configInput>;
      role: ReturnType<typeof configInput>;
      row: HTMLElement;
    }
    const memberRows: MemberRow[] = [];

    function addMember(member: BoardMember): void {
